...
describe("Opepen Renderer", function () {
  ...
  async function deployRandomNFTFixture() {
    ...
    const EightPepenFCRenderer  = await ethers.deployContract("EightPepenFCRendererOpepen");
  ...
  describe("Deployment", function () {
    it("Should Return SVG in Opepen mode", async function () {
