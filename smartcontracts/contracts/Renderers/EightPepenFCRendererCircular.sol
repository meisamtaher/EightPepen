...
contract EightPepenFCRendererCircular is BaseRenderer{
    ...
    function getSVG(uint256[2] calldata pixelColors, uint24 bgColor) public pure returns (string memory) {
        ...
        //  that shows the color index in the colors variable 
        string memory image = string(abi.encodePacked(
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" shape-rendering="geometricPrecision" width="512" height="512">',
