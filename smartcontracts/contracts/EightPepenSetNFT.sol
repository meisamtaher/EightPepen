...
contract EightPepenSetNFT is ERC721 {
    ...
    constructor(IEightPepenRenderer _renderer, IERC721 _baseNFT)ERC721("Eight Pepen", "8PEPEN"){
        renderer = _renderer;
        baseNFT = _baseNFT;
    }
    function mint(uint256 _pixelColors, uint256 _colorPalette) public payable {
        ...
        imageData[tokenId].colorPalette= _colorPalette;
        // Mint token
